...
vit_type = 'vit_h'
dataset_name = 'cocoa'
img_root = '/home/weientai18/ais/data/datasets/COCOA/{}_imgs'.format(eval_type)
imgemb_root = '/work/weientai18/amodal_dataset/coco_{}ing_imgemb_h'.format(eval_type)
anno_path = anno_dic[eval_type]
anchor_matcher = Matcher(
        thresholds=[0.5], labels=[0, 1], allow_low_quality_matches=False
    )
result_list = []
result_save_path = '/work/weientai18/result_aisformer_best_test_coco.json'
...
if __name__ == "__main__":
    ...
    args.opts=['MODEL.WEIGHTS', '/work/weientai18/aisformer/full_training_cocoa_pre/model_0007999.pth']
